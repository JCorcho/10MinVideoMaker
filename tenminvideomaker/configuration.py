...
CONFIG_KEYS = frozenset(
    {
        ...
        "TENMIN_QUALITY_CONTROL_ENABLED",
        "TENMIN_QC_AUTO_ADVANCE_PASS",
        "TENMIN_QC_LOOPBACK_PORT",
        "TENMIN_QC_LLAMA_EXECUTABLE",
        "TENMIN_QC_LLAMA_VENDOR_ROOT",
        "TENMIN_QC_MODEL_PATH",
        "TENMIN_QC_PROJECTOR_PATH",
        "TENMIN_QC_LLAMA_SHA256",
        "TENMIN_QC_MODEL_SHA256",
